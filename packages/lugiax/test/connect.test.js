...
describe('lugiax.connect', () => {
  ...
  it('connect twoModel areStateEqual true && areStateEqual parameter is object', () => {
    ...
    const [oldUserModelState, oldInfoModelState,] = oldModelState;
    const [newUserModelState, newInfoModelState,] = newModelState;
    const afterChangeData = oldInfoModelState.toJS();
