  ...
  render() {
    return (
      <div>
        ...
        <CommonBotton onClick={this.onGoToBackCount2Click}>
          go count：-2后退两次
        </CommonBotton>
        <CommonBotton onClick={this.onGoToForwardCount2Click}>
          go count：2 前进两次
        </CommonBotton>
        ...
        <CommonBotton onClick={this.onGoBackCount2Click}>
          goBack count：2 后退两次
        </CommonBotton>

        <CommonBotton onClick={this.onGoForwardCount2Click}>
        ...
        <CommonBotton onClick={this.onReplaceClick}>
          replace url: /sport
        </CommonBotton>
        <CommonBotton onClick={this.onGoToBackCount1Click}>
          后退一次
        </CommonBotton>
        <CommonBotton onClick={this.onGoToForwardCount1Click}>
          前进一次
        </CommonBotton>
      </div>
    );
